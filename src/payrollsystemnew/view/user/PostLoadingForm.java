 ...
 * @author User
 */
public class PostLoadingForm extends javax.swing.JFrame {

    /**
     * Creates new form LoadingForm
     */
    public PostLoadingForm() {
        initComponents();
        ...
        new Thread(new Runnable() {
            public void run() {
                for (int i = 70; i < 100; i++) {
                    ...
                    if (i == 80) {
                        label.setText("Adding Administrator...");
                    }
                    if (i == 90) {
                    ...
                    try {
                        ...
                        Logger.getLogger(PostLoadingForm.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }).start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostLoadingForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
