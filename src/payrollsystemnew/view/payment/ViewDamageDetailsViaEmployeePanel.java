 ...
 * @author User
 */
public class ViewDamageDetailsViaEmployeePanel extends javax.swing.JPanel {
    public static ViewDamageDetailsViaEmployeePanel viewLoanDetailsViaEmployeePanel;
    
    /**
     * Creates new form employeePanel
     */
    public ViewDamageDetailsViaEmployeePanel() {
        initComponents();
        try {
            viewLoanDetailsViaEmployeePanel=this;
            fillDepartmentNameCombo();
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(ViewDamageDetailsViaEmployeePanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        damageTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Damage ID", "Date", "Description", "Damage Cost"
            }
        ));
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        try {
            ArrayList<Damage> damegeList=PaymentController.getAllDamages(employeeIDCombo.getSelectedItem().toString());
            DefaultTableModel tableModel=(DefaultTableModel) damageTable.getModel();
            tableModel.setRowCount(0);
            for(Damage damage : damegeList){
                Object[] rowData={damage.getDamageID(),damage.getDate(),damage.getDescription(),damage.getDamageCost()};
