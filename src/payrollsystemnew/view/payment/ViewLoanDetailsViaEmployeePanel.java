 ...
 * @author User
 */
public class ViewLoanDetailsViaEmployeePanel extends javax.swing.JPanel {
    public static ViewLoanDetailsViaEmployeePanel viewLoanDetailsViaEmployeePanel;
    
    /**
     * Creates new form employeePanel
     */
    public ViewLoanDetailsViaEmployeePanel() {
        initComponents();
        try {
    ...
    private void processButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processButtonActionPerformed
        try {
            ArrayList<Loan> loanList=PaymentController.getAllLoans(employeeIDCombo.getSelectedItem().toString());
