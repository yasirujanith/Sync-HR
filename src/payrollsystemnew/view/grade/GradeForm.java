...
public class GradeForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(searchButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 200, 100));
        ...
        jPanel1.add(editButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 250, 200, 100));
        ...
        jPanel1.add(addButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 200, 100));
        ...
        jLabel1.setText("--Grade Settings--");
        ...
        jPanel1.add(gradePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 50, 790, 400));
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 450, 990, 50));
        ...
        jPanel1.add(viewButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 200, 100));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        gradePanel.removeAll();
        SearchGradePanel p1=new SearchGradePanel();
        p1.setSize(gradePanel.getSize());
        gradePanel.add(p1);
        gradePanel.repaint();
        gradePanel.revalidate();
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        gradePanel.removeAll();
        EditGradePanel p1=new EditGradePanel();
        p1.setSize(gradePanel.getSize());
        gradePanel.add(p1);
        gradePanel.repaint();
        gradePanel.revalidate();
    ...
    private void viewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewButtonActionPerformed
        gradePanel.removeAll();
        ViewGradePanel p1=new ViewGradePanel();
        p1.setSize(gradePanel.getSize());
        gradePanel.add(p1);
        gradePanel.repaint();
        gradePanel.revalidate();
